...
<div className="z-30 basis-3/5 mt-12 md:mt-32 ">
        ...
        >
          <p className="text-6xl font-playfair  text-center md:text-start text-red">
        <p className="text-3xl text-blue" p={2}> Welcome to</p> 
            
             My Creative Uinverse
